  ...
  const projects = [
    {
      ...
      description:
        "Revolutionary analytics platform using machine learning to provide real-time insights for enterprise clients. Features advanced data visualization and predictive modeling with WebGL-accelerated charts.",
      technologies: [
        "React",
        "TypeScript",
        "Python",
    ...
    },
    {
      ...
      description:
        "Headless commerce platform with micro-frontend architecture, supporting millions of transactions with sub-200ms response times. Built with modern serverless architecture.",
      technologies: [
        "Next.js",
        "GraphQL",
        "Microservices",
    ...
    },
    {
      ...
      description:
        "WebRTC-based collaboration platform with simultaneous editing, voice/video calls, and advanced permission systems. Supports real-time document collaboration.",
      technologies: [
        "Vue.js",
        "WebRTC",
        "Socket.io",
    ...
    },
    {
      ...
      description:
        "Decentralized finance platform with smart contracts, yield farming, and cross-chain functionality. Built on Ethereum with Layer 2 scaling solutions.",
      technologies: [
        "Solidity",
        "Web3.js",
        "React",
  ...
  const experiences = [
    {
      ...
      period: "2023 - Present",
      description:
        "Leading development of next-generation web applications serving millions of users. Architecting scalable solutions and mentoring engineering teams across multiple time zones.",
      achievements: [
    ...
    },
    {
      ...
      period: "2021 - 2023",
      description:
        "Built enterprise-grade applications with focus on performance, security, and scalability. Implemented microservices architecture and comprehensive CI/CD pipelines.",
      achievements: [
        "50% cost reduction",
    ...
    },
    {
      ...
      period: "2020 - 2021",
      description:
        "Developed user-centric interfaces and improved conversion rates through data-driven optimizations, A/B testing, and comprehensive user research.",
      achievements: [
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white flex overflow-hidden">
      ...
      <div className="w-2/5 min-h-screen relative overflow-hidden bg-gradient-to-br from-gray-900 via-blue-900/10 to-purple-900/10">
        ...
        <div
          className="absolute top-1/4 left-1/4 w-32 h-32 bg-gradient-to-br from-blue-500/20 to-purple-500/20 rounded-full blur-2xl animate-pulse"
          style={{ animationDuration: "4s" }}
        ></div>
        <div
          className="absolute bottom-1/3 right-1/4 w-24 h-24 bg-gradient-to-br from-pink-500/20 to-orange-500/20 rounded-full blur-2xl animate-pulse"
      ...
      <div className="flex-1 h-screen overflow-y-auto" ref={scrollContainerRef}>
        <div className="min-h-full bg-gray-800/30">
          ...
          <section
            id="about"
            className="min-h-screen flex items-center px-8 lg:px-16 py-20"
          >
            <div className="max-w-4xl">
              ...
              <div className="space-y-6 text-lg text-gray-300 leading-relaxed mb-12">
                <p>
                  I started my journey in software development back in 2018,
                  diving into web technologies with a passion for creating
                  digital experiences that matter. What began as curiosity about
                  how websites work has evolved into deep expertise in
                  full-stack development.
                </p>
                <p>
                  Today, I specialize in building scalable web applications
                  ...
                  visions to life while focusing on performance, accessibility,
                  and user experience.
                </p>
                <p>
                  When I'm not coding, you'll find me exploring new
                  technologies, contributing to open-source projects, mentoring
                  junior developers, and sharing knowledge through technical
                  writing.
                </p>
              </div>
            ...
            <div className="max-w-4xl">
              ...
              <div className="space-y-12">
                {experiences.map((exp, index) => (
                  <div
                    key={index}
                    className="group relative pl-8 border-l-2 border-gray-700 hover:border-blue-500 transition-all duration-300"
                  >
                    ...
                    <div className="bg-gray-800/50 backdrop-blur-sm p-8 rounded-2xl border border-gray-700 hover:border-blue-500/50 transition-all duration-300 hover:bg-gray-800/70">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {exp.technologies.map((tech, i) => (
                          <span
                            key={i}
                            className="px-3 py-1 bg-blue-500/10 border border-blue-500/20 rounded-full text-blue-300 text-xs"
                          >
                            {tech}
                          </span>
                        ))}
          ...
          <section
            id="contact"
            className="min-h-screen flex items-center px-8 lg:px-16 py-20 bg-gradient-to-br from-gray-800/50 to-gray-900/50"
          >
            <div className="max-w-4xl">
              <div className="mb-12">
                <h2 className="text-5xl font-bold mb-6 bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent">
              ...
              <div className="space-y-8">
                <p className="text-xl text-gray-300 leading-relaxed">
                  ...
                  create innovative solutions. Whether you're a startup looking
                  to build something amazing or an established company wanting
                  to innovate, let's connect and discuss how we can bring your
                  vision to life.
                </p>
                ...
                <div className="text-center pt-8">
                  <p className="text-gray-400 flex items-center justify-center space-x-2">
                    <MapPin className="w-4 h-4" />
                    <span>
                      Based in San Francisco • Available worldwide • Remote
                      friendly
                    </span>
                  </p>
                </div>
